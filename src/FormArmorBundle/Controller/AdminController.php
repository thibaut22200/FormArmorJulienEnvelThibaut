...
{
    public function authentif(Request $request) // Affichage du formulaire d'authentification
    {
		...
		if ($request->getMethod() == 'POST')
		{
			...
			if ($form->isValid())
			{
				...
				$request->getSession()->getFlashBag()->add('connection', 'Login ou mot de passe incorrect');
			}
		}
